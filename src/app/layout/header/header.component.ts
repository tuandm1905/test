...
//     allActiveLinks.forEach(link => link.classList.remove(activeClass));

//     // Tìm liên kết hiện tại dựa trên router link
//     const selector = document.querySelector(`ul.horizontal-menu a[routerLink="${this.router.url}"]`);
//     if (selector) {
//         selector.classList.add(activeClass);
        
//         // Kiểm tra sub-menu và thêm lớp active cho menu cha
